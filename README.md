...
This repo contains project work I carried out as the midterm project in the [mlzoomcamp](https://github.com/DataTalksClub/machine-learning-zoomcamp). The course was organised by [Alexy Grigorev](https://github.com/alexeygrigorev).
